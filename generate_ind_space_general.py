...
div_description = Div(text=""" <h3>Пространство индустрии Казахстана </h3> <br>
Выше представлено пространство отраслей Казахстана, на основе реальных данных по районам и подклассам. <br>
...
layout = gridplot([[div_legend, column(select , select_grand_section,numeric_input,plot)] , [ None, div_description]])
